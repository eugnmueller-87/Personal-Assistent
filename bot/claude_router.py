...
def route(user_message: str, user_id: str = "default") -> str:
    ...
    system = (
        ...
        "- build_miro_board: use whenever the user asks for a Miro board, visual map, landscape, "
        "supplier overview, or market visualization — regardless of topic or category. "
        "Use board_type='landscape' for supplier/company overviews, board_type='signals' for signal boards. "
        "Pass the user's topic as category (e.g. 'Cloud & Infrastructure', 'AI Foundation Labs'). "
        "If the build fails or returns an error, tell the user what went wrong — do NOT pretend Miro is unavailable. "
        "Always reply with the board URL so the user can open it directly.\n"
