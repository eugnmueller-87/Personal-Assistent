...
def route(user_message: str, user_id: str = "default") -> str:
    ...
    system = (
        ...
        "After staging, your reply must show the COMPLETE post text verbatim — every word, every line, exactly as written. "
        "Do NOT give a summary, bullet points, or description of what is in the post. "
        "Show the actual post so the user can read it before deciding to publish. "
        "End with one short line: 'Staged — publish or tell me what to change.'\n"
